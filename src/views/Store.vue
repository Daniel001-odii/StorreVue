...
<div v-if="newProductModal" class="st_modal_container">
    <div class="st_modal">
        <div class="modal_header fs-3">
            <span>Create a new product</span>
            <span class="close_btn"  @click="newProductModal = !newProductModal">&times;</span>
        </div>
        <div class="st_modal_content">
        <form @submit.prevent="createProduct">
            <!-- <div class="mb-3">
                <label for="productImage" class="form-label">product image*</label>
                <input type="file" class="form-control mb-2" id="productImage" required>
            </div> -->
            <div class="mb-3">
                <label for="productName" class="form-label">product name*</label>
                <input type="text" class="form-control mb-2" v-model="product.name" id="productName" required>
            </div>
            <div class="mb-3">
                <label for="productPrice" class="form-label">product price*</label>
                <input type="number" class="form-control mb-2" v-model="product.price" id="productPrice" required>
            </div>
            <div class="mb-3">
                <label for="productDescription" class="form-label">product description*</label>
                <input type="text" class="form-control mb-2" v-model="product.description" id="productDescription" required>
            </div>
            <div class="mb-3">
                <label for="productQuantity" class="form-label">product quantity*</label>
                <input type="number" class="form-control mb-2" v-model="product.quantity" id="productQuantity" required>
            </div>
            <div class="st_modal_footer">
                <button class="btn btn-danger" @click="newProductModal = !newProductModal">close</button>
                <button type="submit" style="background: #8a2be2 !important; color: #fff;" class="btn">Create product</button>
            </div>
        </form>
        </div>
    </div>
...
<div v-if="!loading" class="container pt-5 px-5 text-start">
        <h1 class="fw-bolder">{{ store.name }}</h1>
        <!-- {{ user }} -->
        ...
        <div class="db_stat_row">
            ...
            <div class="dashboard_stat">
                ...
                <div class="dashboard_stat_inner">
                    <div class="db_stat_number">{{ store.views }}</div>
        ...
        <div class="db_stats mt-5">
            ...
            <div class="db_record_stat">
                <div v-for="(activity, index) in userActivity" :key="index">
                    <RouterLink :to="'/activity/' + activity._id" target="_blank" style="text-decoration: none !important;">
                        ...
                        <!-- {{ activity }} -->
                                ...
                                <div>{{ activity.product.name }} - <b v-if="activity.customer">{{activity.customer.name }}</b></div>
                            </div>
        ...
        <div class="db_header mt-5">
            ...
            <div class="d-flex flex-row gap-3">
                <button class="btn btn-primary" @click="newProductModal = !newProductModal"><i class="bi bi-box2-fill"></i>  Add New Product</button>
        ...
        <br/><br/>
        <div class="fs-3" v-if="store.products">Available products: {{ store.products.length }}</div>
        <div><RouterLink to="/customers">See all customers</RouterLink></div>
    ...
    export default {
        ...
        methods:{
            ...
            async getActivities(){
                ...
                try{
                    const response = await axios.get(`${this.api_url}/activities/${this.$route.params.storeId}`, {headers});
